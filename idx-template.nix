...
# Define the variable for the dev.nix file path
devNixFile="$out/.idx/dev.nix"

# Write the multi-line string to the devNixFile
printf '%s\n' 'var = pkgs.writeText "dev.nix" ''
  # To learn more about how to use Nix to configure your environment
  # see: https://developers.google.com/idx/guides/customize-idx-env
  { pkgs }:
  let
    flutterProjectDir = \"$out\"; # Define your Flutter project directory here
    laravelProjectDir = \"$out\"; # Define your Laravel project directory here
  in 
  {
